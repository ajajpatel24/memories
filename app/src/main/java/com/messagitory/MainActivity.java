...
public class MainActivity extends AppCompatActivity implements ClickCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goPublic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, MyMessagesActivity.class);
                startActivity(i);
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (messageEdit.getText().toString().equals("")) {
                    ...
                    Toast.makeText(MainActivity.this, "Message should be less than 240 characters.", Toast.LENGTH_LONG).show();
                } else {
    ...
    public void getMessages() {
        ...
        messageCall = restInterface.getMessageList(deviceID);
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    if (!response.body().equals("")) {
                        Toast.makeText(MainActivity.this, "Message posted successfully.", Toast.LENGTH_LONG).show();
                        getMessages();
                    } else {
                        Toast.makeText(MainActivity.this, "Error posting message.", Toast.LENGTH_LONG).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
