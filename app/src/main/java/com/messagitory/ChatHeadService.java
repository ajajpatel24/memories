...
public class ChatHeadService extends Service {
    ...
    public void onCreate() {
        // TODO Auto-generated method stub
        super.onCreate();
        Log.e(Utils.LogTag, "ChatHeadService.onCreate()");
        ServiceModel.getInstance().update(this, "ON");
        handleStart();
    }
    ...
    private void handleStart() {
        ...
        chatheadView.setOnTouchListener(new View.OnTouchListener() {
            ...
            Runnable runnable_longClick = new Runnable() {
                ...
                public void run() {
                    // TODO Auto-generated method stub
                    Log.e(Utils.LogTag, "Into runnable_longClick");
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        break;
                    default:
                        Log.e(Utils.LogTag, "chatheadView.setOnTouchListener  -> event.getAction() : default");
                        break;
                }
                return true;
            }
        ...
        txt1 = (TextView) txtView.findViewById(R.id.categoryName);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            Log.e(Utils.LogTag, "ChatHeadService.onConfigurationChanged -> landscap");
            ...
            Log.e(Utils.LogTag, "ChatHeadService.onConfigurationChanged -> portrait");
    ...
    private void chathead_longclick() {
        Log.e(Utils.LogTag, "Into ChatHeadService.chathead_longclick() ");
    ...
    public void onDestroy() {
        ...
        if (chatheadView != null) {
            //Toast.makeText(getApplicationContext(), "chathead Called", Toast.LENGTH_LONG).show();
            windowManager.removeView(chatheadView);
        }

        if (txtView != null) {
            windowManager.removeView(txtView);
            //Toast.makeText(getApplicationContext(), "txtview Called", Toast.LENGTH_LONG).show();
        }

        if (removeView != null) {
            windowManager.removeView(removeView);
            //Toast.makeText(getApplicationContext(), "removeview Called", Toast.LENGTH_LONG).show();
        }
        ...
        t.send(new HitBuilders.EventBuilder()
                ...
                .build());
        ServiceModel.getInstance().update(this, "OFF");
    }
    ...
    public IBinder onBind(Intent intent) {
        // TODO Auto-generated method stub
        Log.e(Utils.LogTag, "ChatHeadService.onBind()");
        return null;
    }
